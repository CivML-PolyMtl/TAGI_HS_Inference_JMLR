...
% Description:  perform adversarial attack on Mnist with 2 separate nets
...
trainedModelDirA = ['results/dropconnect_B16_He__V1_E50_mnist']; 
trainedModelDirD = ['results/dropconnect_B16_He__V2_E50_mnist']; 
initEpoch       = 0;
%% Run
task.adversarialAttack_V2(net, net, testImdb, trainedModelDirA, trainedModelDirD, initEpoch)
